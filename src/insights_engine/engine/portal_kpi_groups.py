...
Generated from configkpisclientportal KPI1..KPI5 group flags. A row in
maininsightsportal matches a group if ANY of its (comma-separated) KPIs is in the
group set. A KPI may belong to multiple groups (e.g. real_pipeline_value).
"""

from __future__ import annotations

# group_id -> list of KPI names (kpiname slugs in configkpisclientportal)
