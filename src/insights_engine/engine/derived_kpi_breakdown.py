"""Portfolio-level breakdown of portal KPIs by Portal dimensions."""
...
async def fetch_derived_kpi_breakdown(
    ...
    *,
    ...
    """Return each portal KPI broken down by Portal dimensions."""
    ...
    for name in allow:
        ...
        for dim_name in PORTAL_KPI_BREAKDOWN_DIMENSIONS:
            ...
            if dim_ref is None:
                dim_block["error"] = (
                    f"Dimension '{dim_name}' is not mapped in config_dimensionsreunityportal"
                )
