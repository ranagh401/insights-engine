...
def _configure_quiet_loggers() -> None:
    ...
    cfg_log = logging.getLogger("insights_engine.config.config_loader")
    ...
    feat_log = logging.getLogger("insights_engine.engine.feature_generator")
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="Insights Engine — PBI DAX",
        description=(
            "Portal-dedicated fork: KPI analytics, signal detection, and WHY analysis "
