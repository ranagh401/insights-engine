...
from platform_core.auth.jwt import JWTManager
from platform_core.config.settings import create_service_config, find_project_root
from platform_core.config.validation import ServiceConfig, ServiceDetails
from platform_core.observability import logger
...
class DatabricksConfig(BaseModel):
    ...
    schema_name: str = Field(default="client_insights_portal", description="Schema/database name")
