...
class PortalKpiNameOption(str, Enum):
    """Legacy Swagger examples — any ``kpiname`` from configkpisclientcrm is accepted."""
...
KpiNameQuery = Annotated[
    ...
    Query(
        title="KPI name",
        description="KPI ``kpiname`` from insights.configkpisclientcrm.",
...
InsightKpiNameQuery = Annotated[
    ...
    Query(
        ...
        description=(
            ...
            "Must be a ``kpiname`` in insights.configkpisclientcrm. "
...
@router.get(
    ...
    summary="Fetch portal KPI tiles from configkpisclientcrm",
    description=(
        "Portfolio-level KPI tiles with prior-period comparison. "
        "KPI list and PBI measures come from **insights.configkpisclientcrm** "
