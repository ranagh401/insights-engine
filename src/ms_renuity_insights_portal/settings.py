...
class LlmSettings(BaseSettings):
    ...
    ONEPLATFORM_OPENAI__API_KEY: str
    ONEPLATFORM_OPENAI__ENDPOINT: str
    ONEPLATFORM_OPENAI__DEPLOYMENT: str
    ONEPLATFORM_OPENAI__API_VERSION: str = "2024-02-15-preview"
    ONEPLATFORM_OPENAI__TEMPERATURE: float = 0.2
