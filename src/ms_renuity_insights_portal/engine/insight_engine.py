...
# Repo root (``ms-insights-portal-renuity/``) — default ``prompt_logs/`` when ``INSIGHTS_PROMPT_LOG_DIR`` is unset.
...
_CRM_PIPELINE_BUSINESS_CONTEXT = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SECTION 1 — BUSINESS MODEL: CRM B2B SALES PIPELINE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Potential Type, Opportunity Type, Industry Head, Stage, Sales Rep — and other configured
  CRM dimensions. When multiple slices fire on the same KPI, explain how they combine or
...
_CRM_NARRATIVE_SYSTEM_PROMPT = (
    "You are an insight writer for a CRM / B2B sales pipeline intelligence portal. "
...
_CRM_NARRATIVE_CORRELATION_PRIORS_JSON = "[]"
...
_ONE_SHOT_KPI_ROLLUP_MAIN_SYSTEM = (
    ...
    "span **multiple CRM analytical dimensions** "
    ...
    "- Do **not** use legacy Renuity home-services funnel language unless those exact metrics "
...
def _kpi_rollup_cross_dimension_block(signals: list[Signal]) -> str:
    ...
    return (
        ...
        "the first dimension listed. Use CRM plain-English dimension names (no underscores).\n"
    )
...
def _resolve_kpi_rollup_period_window(
    ...
    """Prefer WHY period bounds; else CRM default weekly window."""
...
class InsightEngine:
    def __init__(
        ...
        *,
        ...
        self._temperature = settings.ONEPLATFORM_OPENAI__TEMPERATURE
        ...
        self._model = settings.ONEPLATFORM_OPENAI__DEPLOYMENT

        if main_insights_llm == MainInsightsNarrativeModel.azure_default:
            self._openai_async = AsyncAzureOpenAI(
                api_key=settings.ONEPLATFORM_OPENAI__API_KEY,
                api_version=settings.ONEPLATFORM_OPENAI__API_VERSION,
                azure_endpoint=settings.ONEPLATFORM_OPENAI__ENDPOINT,
                max_retries=0,
            )
    ...
    async def generate_kpi_rollup_main_insights(
        ...
        Iterates every row in ``configkpisrenuitycrm`` (or ``kpi_names`` filter). KPIs with
        ...
        if not target_kpis:
            logger.info("KPI rollup main insights: no KPIs in configkpisrenuitycrm.")
            return 0, ts, []
