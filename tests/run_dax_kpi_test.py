...
actual Client config tables.  No hardcoded KPI/dimension references.
...
SCHEMA = os.getenv("PLATFORM_DATABASE__SCHEMA", "insights")
PG_DSN = os.getenv("PLATFORM_DATABASE__URL", "")
...
async def main() -> None:
    print("\n" + "=" * 70)
    print("  CLIENT - DAX KPI Compute Test (Config-Driven)")
    print("=" * 70)
