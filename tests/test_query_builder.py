...
All fixtures use Renuity dimension and measure names.
"""
...
from ms_renuity_insights_portal.config.models import (
        ...
        with pytest.raises(ConfigIncompleteError, match="pbi_measure_name"):
            ...
            if pbi_measure_name is None:
                raise ConfigIncompleteError(
                    ...
                    f"Populate configkpisrenuitycrm.pbi_measure_name "
