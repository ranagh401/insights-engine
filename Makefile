...
CORE_PACKAGE := ../microservice-shared/python-packages/oneplatform_core
SDK_PACKAGE := ../microservice-shared/python-packages/oneplatform_sdk
...
dev-server:
	...
	$(UVICORN) --app-dir src ms_renuity_insights_portal.app:app --host 0.0.0.0 --port 8009 --reload
